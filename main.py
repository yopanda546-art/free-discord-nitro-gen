    ...
    def main(self):
        ...
        if os.name == "nt":
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Promotion Codes Generator and Checker - Made by !!.#9763")
        else:  # Or if it is unix
            print(f'\33]0;Nitro Promotion Codes Generator and Checker - Made by !!.#9763\a',
                  end='', flush=True) 
...
| $$      | $$  | $$| $$  | $$| $$\  $$$  | $$   /$$/\  $$      | $$  \ $$| $$      | $$\  $$$
| $$      | $$  | $$|  $$$$$$/| $$ \  $$ /$$$$$$| $$  \ $$      |  $$$$$$/| $$$$$$$$| $$ \  $$
|__/      |__/  |__/ \______/ |__/  \__/|______/|__/  |__/       \______/ |________/|__/  \__/
